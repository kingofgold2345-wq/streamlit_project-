...
sibsp = st.number_input("Enter Number (Siblings/Spouses)", min_value=0, max_value=10, value=0)
parch = st.number_input("Enter Number (Parents/Children)", min_value=0, max_value=10, value=0)
